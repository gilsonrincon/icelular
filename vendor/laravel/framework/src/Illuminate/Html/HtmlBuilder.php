...
class HtmlBuilder {
	 ...
	 * @return string
	 */
	public function imageLink($url, $href, $target, $alt = null, $attributes = array())
	{
		$href=$this->url->to($href, array(), false);
		
		return '<a href="'.$href.'" target="'.$target.'"'.$this->attributes($attributes).'><img alt="'.$alt.'" src="'.$this->url->asset($url).'"></a>';
	}
